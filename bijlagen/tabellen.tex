...
\setlength\itemsep{0em}
    \item \Cref{tab:research_data}: selectie van platforms voor financi\"ele en economische data   
    \item \Cref{tab:social_infrastructure}: selectie van platforms voor algemene informatie
    \item \Cref{tab:marketinsight_analyses}: selectie van bronnen om inzicht te krijgen in cryptocurrency markten
    \item \Cref{tab:learning_tools_general}: selectie van educatieve platforms
    \item \Cref{tab:security_tools}: selectie van toepassingen om de privacy en veiligheid te verbeteren
\end{enumerate}
\end{cryptobox}
\clearpage
